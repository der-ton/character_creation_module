...
DEFAULT_STAMINA = 80  # Значение стандартной выносливости.
...
def choice_char_class(char_name: str) -> Character:
    """Возвращает объект с выбранным классом персонажа.
    """
    game_classes = {'warrior': Warrior, 'mage': Mage, 'healer': Healer}  # Словарь, в котором соотносится ввод пользователя и класс персонажа.
